...
public class Instruction {
	...
	public byte getShamt() {
		...
		byte shamt;
		int leftshifted_shamt = (instr << 21);
	...
	public byte getFunct() {
		...
		byte funct;
		int leftshifted_funct = (instr << 26);
